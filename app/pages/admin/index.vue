...
const orderStatuses = computed(() => {
  ...
  if (byStatus.length) {
    return byStatus.map((s: any) => ({
      status: s.status,
      count: s.count,
      color: colors[s.status] ?? 'bg-secondary',
    }))
  }
  ...
  <div class="space-y-8">
    ...
    <div class="flex justify-between items-end">
        ...
        <UCard>
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 dark:text-white">3,421</p>
            </div>
          </div>
        </UCard>
      ...
      <UCard>
        <template #header>
          <div class="flex items-center justify-between">
            ...
            <UButton to="/admin/orders" variant="ghost" color="primary"> View All </UButton>
          </div>
        </template>
      ...
      <div class="grid gap-6 md:grid-cols-3">
        <UButton to="/admin/products" color="primary" size="lg" icon="i-heroicons-plus" block>
          Add Product
        </UButton>

        <UButton to="/admin/categories" color="secondary" size="lg" icon="i-heroicons-tag" block>
          Manage Categories
        </UButton>

        <UButton to="/admin/users" color="success" size="lg" icon="i-heroicons-users" block>
          View Users
        </UButton>
      </div>
    </div>
      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div
            ...
            :class="kpi.trend > 0 ? 'text-green-600' : 'text-error'"
          >
        ...
        <div class="bg-surface-container-lowest rounded shadow-sm p-6">
          ...
          <div class="space-y-2">
            <NuxtLink
              ...
              class="flex items-center gap-3 text-sm text-secondary hover:text-primary transition-colors py-1"
            >
