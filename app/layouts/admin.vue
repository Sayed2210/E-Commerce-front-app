...
const navLinks = computed(() => [
  ...
  { to: '/admin/currencies', icon: 'payments', label: t('admin.currencies') },
  { to: '/admin/loyalty', icon: 'stars', label: t('admin.loyalty') },
  { to: '/admin/shipping', icon: 'local_shipping', label: t('admin.shipping') },
...
const pageTitles = computed<Record<string, string>>(() => ({
  ...
  '/admin/currencies': t('admin.currencies'),
  '/admin/loyalty': t('admin.loyalty'),
  '/admin/shipping': t('admin.shipping'),
